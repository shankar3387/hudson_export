                ...
                <div class="row justify-content-start">
                    <div class="col-lg-10">
                        <div class="section-tittle mb-60 text-start pt-10">
							...
							<h1 style="font-size:30px;"><b>Payment</h1>
 <p>While availing any of the payment method/s available on the Platform, we will not be responsible or assume any liability, whatsoever in respect of any loss or damage arising directly or indirectly to You due to:
...
4.	Decline of transaction for any other reasons
