	...
	class ReviewsController extends MY_Controller 
		{
			public function __construct()
				...
				public function index($page = 1)
				{
							...
							$data['review']	=	$this->CommonModel->getsinglerow('tbl_product_reviews',$admin_id,'seller_id');
							$this->load->view("BACKEND/review/index" ,$data);
				}
				public function UpdateReviewstatus(){
							...
							$out= 	$this->CommonModel->updatedataontable("tbl_product_reviews",$updata,$event_id);
