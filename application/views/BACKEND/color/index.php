...
<input type="hidden" name="base_url" id="base_url" value="<?=base_url('')?>" class="form-control" />
    <div class="layout-content">
        <div class="container-fluid flex-grow-1 container-p-y">
            <h4 class="font-weight-bold py-3 mb-0">Color</h4>
            <div class="text-muted small mt-0 mb-4 d-block breadcrumb">
                ...
                <?php if(!empty($this->session->flashdata('message'))){ ?>
                        <div class="alert alert-success alert-dismissible">
                            <a href="<?=base_url('Colors')?>" class="close" data-dismiss="alert" aria-label="close">&times;</a>
            ...
            <div class="card">
                <h6 class="card-header"><button type="button" data-toggle="modal" data-target="#modals-default" class="btn btn-round btn-dark">Add Color</button></h6>
    ...
    <div class="modal fade" id="modals-default">
        <div class="modal-dialog">
            <form class="modal-content" method="post" action="<?=base_url('AddColor')?>" enctype="multipart/form-data">
...
<span class="font-weight-light">Add</span>
    ...
    <div class="modal fade" id="Updateform">
        <div class="modal-dialog">
            <form class="modal-content" method="post" action="<?=base_url('UpdateColor')?>" enctype="multipart/form-data">
                <div class="modal-header">
                    <h5 class="modal-title">Color
<span class="font-weight-light">Update</span>
    ...
    function getData(id){
                 $.ajax({
                        type:'POST',
                        url:'<?php echo base_url("ColorUpdateData"); ?>',
                        data:{'id':id},
    ...
    $(document).on('click', '.actvcity', function() {
        ...
        if (event_id) {
            $.ajax({
                url: '<?php echo base_url("Colorstatus"); ?>',
                type: 'POST',
                dataType: "json",
                data: {
                    'event_id': event_id,
