         ...
         <div class="col-lg-4">
            <div class="card" style="width: 18rem;">
               <ul class="list-group list-group-flush">
                  <li class="list-group-item"><a href="<?=base_url('Myaccount')?>">Dashboard</a></li>
                  <li class="list-group-item"><a href="<?=base_url('OrderHistory')?>">Orders</a></li>
                  <li class="list-group-item"><a href="<?=base_url('cart')?>">Cart</a></li>
                  <li class="list-group-item"><a href="<?=base_url('WishList')?>">Wishlist</a></li>
                  <li class="list-group-item"><a href="#">Address</a></li>
                  <li class="list-group-item"><a href="<?=base_url('AccountDetail')?>">Account details</a></li>
            ...
            <table class="table table-bordered">
               ...
               <tbody>
                  <?php if(!empty($wishlist)){
					 ...
					 if(!empty($product)){ ?>
                  <tr>
                     <th><a style="color:red;" href="<?=base_url('RemoveWish/').$row['id'];?>" onclick="return confirm('Are You Sure Want To Remove?');"><i class="fa fa-remove"></i></a></th>
                     ...
                     <td><a href="<?=base_url('Product/').$row['tbl_product_id']?>"><?=$product[0]['product_name']?></a></td>
                     ...
                     <td>
                     	...
                     	<a class="btn btn-primary" onclick="addtocart(<?=$row['tbl_product_id']?>);" title="Add “<?=$product[0]['product_name']?>” to your cart"><span class="es-cart-btn"><i class="fa fa-shopping-cart"></i> Add to Cart</span></a>
                     </td>
                  </tr>
                  <?php }}}else{ ?>
                  	<tr>
