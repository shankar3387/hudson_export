                ...
                <div class="row justify-content-center">
                    <div class="col-lg-10">
                        <div class="section-tittle mb-60 text-center pt-10">
                            <h2>Google patner</h2>
                            <p class="pera">Google Partner Certification for Google Analytics IQ indicates that Corporate Conversions is proficient "in digital analytics and Google Analytics, including Measurement and implementation planning and Google Analytics configuration and administration.
							" This includes Google Analytics reporting and campaign and channel attribution.</p>
                        </div>
                    </div>
